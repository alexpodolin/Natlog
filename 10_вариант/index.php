...
//Функция Работа с бд postgresql
include ("inc/functions.php");

//Подключение к БД oracle (suremts)
//include ("sql/ora_connect.php");
//Функция Работа с бд oracle (suremts)
//include ("inc/ora_functions.php");
			...
			<div class="main">
				...
				<div class="result">					
					<table id="result-to-xlsx">							
						...
						<?=$table['html_min_log'];
						//подсчет кол-ва строк в таблица
						$row_count = substr_count($table['html_min_log'], "<tr>");
						?>
					</table>
					<h2><?=$table['error']?></h2>
				</div>
				...
				$count = "<div class='counter'>Общее кол-во сессий: $row_count </div>";			
				?>				
