...
if (isset($_GET['print']))
{
	...
	$var_fields = array("Время", "Протокол", "Приватный адрес", "VRF-источник", "Адрес трансляции", "Оригинальный порт",
					"Порт трансляции", "Адрес назначения", "Порт назначения");
			...
			<div class="main">
				<div class="left-menu">
					...
					<p>Приватный IP адрес:</p>
						<input id="tags" autocomplete="on" maxlength="15" name="where[original_source_ip]" type="text">

					<p>IP адрес трансляции:</p>
						<input autocomplete="on" maxlength="15" name="where[translated_source_ip]" type="text">

					<p>IP адрес назначения:</p>
						<input autocomplete="on" maxlength="15" name="where[destination_ip]" type="text">

					<p>Оригинальный порт:</p>
						<input autocomplete="on" maxlength="5" name="where[original_port]" type="text">

					<p>Порт трансляции:</p>
						<input autocomplete="on" maxlength="5" name="where[translated_first_source_port]" type="text">

					<p>Порт назначения:</p>
						<input autocomplete="on" maxlength="5" name="where[destination_port]" type="text">
