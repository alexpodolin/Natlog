			...
			<div class="main">
				<div class="left-menu">
						...
						<p>Приватный IP адрес:</p>
							<input id="tags" autocomplete="on" maxlength="15" name="where[orig_src_ipv4]" type="text">
				...
				<div class="icon">
					<a href="#" target="_blank"><img src="/img/printer16x16.png" alt="Версия для печати" title="Версия для печати">&nbsp;Версия для печати</a>
					<br>
